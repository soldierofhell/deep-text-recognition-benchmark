...
class GridGenerator(nn.Module):
    ...
    def __init__(self, F, I_r_size):
        ...
        self.register_buffer("inv_delta_C", torch.tensor(self._build_inv_delta_C(self.F, self.C), dtype=torch.float))  # F+3 x F+3
        self.register_buffer("P_hat", torch.tensor(self._build_P_hat(self.F, self.C, self.P), dtype=torch.float))  # n x F+3
    ...
    def _build_P_hat(self, F, C, P):
        ...
        rbf = torch.mul(torch.sqrt(rbf_norm), torch.log(rbf_norm + self.eps))  # n x F
